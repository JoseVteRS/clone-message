...
import { useIsMountedComponent } from "@/hooks/useIsMountedComponent"
...
export const AuthForm = () => {
  ...
  const mounted = useIsMountedComponent()
    ...
    <div className="mt-8 sm:mx-auto sm:w-full sm:max-w-md">
      ...
      <div className="bg-white px-4 py-8 shadow sm:rounded-lg sm:px-10">
        <form className="space-y-6" onSubmit={handleSubmit(onSubmit)}>
          {variant === "REGISTER" && (
            <Input disabled={isLoading} label="Name" type="text" register={register} id="name" errors={errors} />
          )}
